...
def crawl_refinery29(url):
    ...
    for content in news_lists_soup.div.contents:
        ...
        urls.append(url + str(content_soup.div.a['href']))
    print('Latest News Count : ' + str(len(urls)))
            ...
            if len(rows) > 0:
                for row in rows:
                    ...
                    for card in cards:
                        ...
                        urls.append(url + str(card_soup.div.a['href']))
                        '''
                        # section
                        ...
                        '''
    print('Trending and Now on R29 Count : ' + str(len(urls)))
    fn = open("/Users/anthony/Desktop/R29.txt", "w")
    print('--------------Translating----------')
    progress_rate = 0
    urls_2 = list(set(urls))
    for resource in urls_2:
